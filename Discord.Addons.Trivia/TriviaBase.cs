...
{
    /// <summary>
    /// Base class for Trivia games on Discord.
    /// </summary>
    public abstract class TriviaBase : ModuleBase
    {
        /// <summary>
        /// Indicates if a game is already being played.
        /// </summary>
        protected readonly bool GameInProgress;

        /// <summary>
        /// The instance of the game being played, if so.
        /// </summary>
        protected readonly TriviaGame Game;

        /// <summary>
        /// The instance of the <see cref="TriviaService"/>.
        /// </summary>
        ...
        /// <summary>
        /// End an ongoing Trivia game early.
        /// </summary>
