    ...
    public sealed class PermissionsModule : ModuleBase
    {
        ...
        public async Task SetAdminRole(IRole role)
        {
            if (Context.Channel is IGuildChannel ch)
            {
                ...
                if (await _permService.SetGuildAdminRole(Context.Guild, role))
        ...
        public async Task SetModRole(IRole role)
        {
            if (Context.Channel is IGuildChannel ch)
            {
                ...
                if (await _permService.SetGuildModRole(Context.Guild, role))
        ...
        public async Task WhitelistModule(string modName)
        {
            ...
            if (mod != null)
            {
                if (await _permService.WhitelistModule(ch, mod.Name))
        ...
        public async Task BlacklistModule(string modName)
        {
            ...
            if (mod != null)
            {
                ...
                {
                    if (await _permService.BlacklistModule(ch, mod.Name))
