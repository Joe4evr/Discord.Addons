namespace Discord.Addons.SimpleAudio
{
    ...
    public sealed class StandardAudioGuildConfig : IAudioGuildConfig
    {
        ...
        /// <summary> Sets the ID of the Voice channel in this guild to auto-connect to
        ...
        /// <summary> Sets the ID of the Message channel in this guild to post
        ...
        /// <summary> Sets whether or not to auto connect to a voice channel
        ...
        /// <summary> Sets whether or not to start auto-playing
        ...
        /// <summary> Sets whether or not to allow control via commands in this guild.
        ...
        /// <summary> Sets whether or not to allow control via reactions in this guild. </summary>
        public bool AllowReactions { set => _allowReactions = value; }
        bool IAudioGuildConfig.AllowReactions => _allowReactions;

        /// <summary> Sets whether or not to show the available
